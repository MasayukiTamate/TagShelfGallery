...
> 本ファイルはルート直下の `errarlog.md`（スペルミス）と `docs/errorlog.md` を統合したものです。日付の古い順に記載しています。
...
- **Action**: Always double-check `errorlog.md` and verify impacts before deleting code.
